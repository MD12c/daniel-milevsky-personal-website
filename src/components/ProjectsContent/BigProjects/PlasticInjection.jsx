...
export default function PlasticInjection() {
    ...
    return (
        <div className="mb-8">
            ...
            <p>
                This was the final project of the program. The goal was
                demonstrate the things we had learned over the 3 years in Dawson
                by making a prototype that would solve an environmental problem.
                We decided to make a plastic injection molding machine, which is
                a machine that can melt plastic pellets and inject them into a
                mold to create a plastic part. We took on this challenge because
                the department of Mech-Tech at Dawson was producing alot of
                plastic waste from 3D printing. We wanted to find a way to
                recycle that waste and make it into new parts. Here is how it
                came out:
            </p>
            ...
            <p>
                ...
                Above is a picture of the stand we made for the presentation. We
                also made a poster explain the project to the visitors.
            </p>
            <div className="flex justify-center w-full mt-5 ml-1.5 py-4">
                <img
            ...
            <p>
                ...
                the program as well as train my collaborative and team management
                skills in the process. We learned about:
