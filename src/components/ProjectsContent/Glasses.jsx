...
export default function Glasses() {
    ...
    return (
        <div className="mb-8">
            <h2 className="text-3xl font-oxanium-bold mb-5">Glasses</h2>
            ...
            <p>
                ...
                pair of glasses that would fit perfectly using 3D scanning
            ...
            <p>
                I learned how to use surface modeling tools and how to
                design for heat-set inserts to screw on the hinges.
            </p>
        </div>
    );
}
